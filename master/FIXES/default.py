...
try:
    ...
    ok=dialog.ok('[B][COLOR=FF67cc33]Mash Up Import Error[/COLOR][/B]','Failed To Import Needed Modules',str(e),'Report missing Module at [COLOR=FF67cc33]MafiaTVxbmc.com[/COLOR] to Fix')
...
def INTCAT(murl):
    if 'italian'in murl:
        main.addDir('Cinema Italiano','https://raw2.github.com/mafiatv/MafiaTVRepo/master/CinemaItaliano/cinemaitaliano_directory.xml',236,art+'/intl.png')
        main.addDir('Italian Series','https://raw2.github.com/mafiatv/MafiaTVRepo/master/Foriegn/italianseries.xml',236,art+'/intl.png')
        main.addDir('Live Italian TV','https://raw2.github.com/mafiatv/MafiaTVRepo/master/Foriegn/italianLiveTV.xml',236,art+'/intl.png')
    if 'russian' in murl:
...
def MAINDEL(murl):
    ...
    if 'Malformed' in murl:
        ...
        dialog = xbmcgui.Dialog()
        if dialog.yesno('Mash Up', 'Are you sure you want to clear MafiaTV Cache & Cookies?','','','No', 'Yes'):
            import os
